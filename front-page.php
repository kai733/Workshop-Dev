...
<div class="quiz">
    ...
    <div class="wrapper">
            ...
            <div class="question-card <?php echo $active_class; ?>">
                ...
                <div class="answer-list">
                    ...
                    <?php foreach ($question["answers"] as $key => $answer_data): ?>
                        <button class="answer" data-value="<?php echo $answer_data["answer_value"]; ?>">
        ...
        $result_3 = $quiz["result_3"]
            ?>
        <div class="result" id="result-1" style="display: none;">
        ...
        <div class="result" id="result-2" style="display: none;">
            <div class="result-left">
        ...
        <div class="result" id="result-3" style="display: none;">
            <div class="result-left">
